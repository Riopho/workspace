...
#ifdef _DEBUG
#define	STRINGID_USESTRINGCONTENT	1
#endif

#ifdef _DEBUG
#define	STRINGID_DEBUG_CASE
#endif
...
#define	STRINGID_RESOLVE_CONTENT

#endif

#if !STRINGID_USESTRINGCONTENT && !defined(STRINGID_RESOLVE_CONTENT) && !defined(STRINGID_DEBUG_CASE)
// This should only be defined if we have nothing but the IDType in the CStringID instance.  (i.e. a retail build)
#define STRINGID_RETAIL_OPTIM
#endif
...
/*!
*   - in STRINGID_USESTRINGCONTENT, we store the behaviac::string source
...
#endif
#ifdef STRINGID_RESOLVE_CONTENT
...
////////////////////////////////////////////////////////////////////////////////
#if defined(STRINGID_RETAIL_OPTIM)
